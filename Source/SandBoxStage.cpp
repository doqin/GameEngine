...
void SandBoxStage::HandleEvents()
{
	...
	while (SDL_PollEvent(&e)) {
		...
		screen->playerController.HandleEvents(e, &screen->playerRigidBody);
	}
}

void SandBoxStage::FixedUpdate()
{
	for (auto rigidBody : screen->rigidBodies) {
		rigidBody->Update(screen->boundaryColliders, screen->boxColliders);
	}
